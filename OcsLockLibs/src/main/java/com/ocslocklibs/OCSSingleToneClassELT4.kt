    ...
    constructor(
        ...
        activity.runOnUiThread {
            try {
                ...
                extendedLicense.masterCode = extendedLicense.masterCode
                if (isSetMasterCode) {
                ...
                Log.e("master_code_1_" ,  "" + extendedLicense.masterCode)
...
//                            }
                            ...
                            Log.e("master_code_3_" ,  "" + extendedLicense.masterCode + " : " + ocsMasterCode)
